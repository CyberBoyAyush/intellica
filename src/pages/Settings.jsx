...
const Settings = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50 p-6">
      ...
      >
        {/* Profile Card */}
        <motion.div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-purple-100/30">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 rounded-xl border ${
                    isEditing ? 'border-purple-200' : 'border-transparent bg-gray-50'
              ...
              {updateStatus.message && (
                <motion.div
                  ...
                  className={`p-4 rounded-xl ${
                    ...
                    updateStatus.type === 'success' ? 'bg-green-50 text-green-600' :
