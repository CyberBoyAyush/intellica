...
const Footer = () => {
  const handleReportBug = () => {
    window.location.href = "mailto:connect@ayush-sharma.in?subject=Report%20Feedback/Bug%20on%20Intellica";
  };

  const socialLinks = [
    { 
      icon: <RiGithubFill className="w-6 h-6" />, 
      href: 'https://github.com/cyberboyayush/intellica',
      label: 'GitHub'
    },
    { 
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            >
              <RiReactjsLine className="text-3xl text-purple-600 animate-spin-slow" />
            ...
            >
              ...
              <a 
                href="https://intellica.ayush-sharma.in" 
                target="_blank" 
        ...
        >
          © {new Date().getFullYear()} Intellica. All rights reserved.
        </motion.p>
      </div>
    </footer>
  );
